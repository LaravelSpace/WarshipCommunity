...
开始编写数据字典，把所有的字段说明统一到一处进行维护。

#### 2020-03-09 ~ 2020-03-14

摸索 laravel-echo-server 私有频道。
...
增加 ./app/Service 目录，这么做是为了让功能模块的 Service 和框架本身的模块目录可以直接映射。比如：Community 功能模块 App/Service/Community 和框架本身的 Job 模块 App/Job/Community 可以直接映射。
