    ...
    <div>
        ...
        <nav aria-label="article paginate navigation">
            <ul class="pagination pagination-lg justify-content-center">
                ...
                <li class="page-item" v-for="page in paginate.page_list"><a class="page-link" href="#" :href="pageUrl(page)">@{{ page }}</a></li>
